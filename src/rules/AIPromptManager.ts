...
export const createFirstQuestionPrompt = (question: string): string => 
    `We are playing ${MAX_QUESTIONS} questions. Think of a common, well-known thing and answer this first question: ${question}. Please avoid these common items: ${commonTwentyQuestionsItems.join(', ')}. Return a JSON string with an "object" and "answer" strings.`;
